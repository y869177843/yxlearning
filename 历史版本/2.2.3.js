...
// @license       MIT
// @description   智能续播 (强化) + 自动跳题/答题屏蔽 + 静音 + 控制台日志，根据mumu+AI 1.0 使用Gemini改进。适用于大众云学平台yxlearning.com中的公需课和专业课内容.导入油猴脚本使用，浏览器需开启开发者模式,注意事项：在某些情况下需要自己点击进度条跳转进度，刷课尚不能完全自动化。
// ==/UserScript==

(function() {
    'use strict';

    console.log('[yxlearning脚本] V2.2.3 脚本已启动 (document-start)。');
